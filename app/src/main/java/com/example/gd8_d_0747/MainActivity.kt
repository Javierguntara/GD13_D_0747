...
import com.example.gd8_d_0747.R.*
import com.example.gd8_d_0747.adapters.MahasiswaAdapter
import com.example.gd8_d_0747.api.MahasiswaApi
import com.example.gd8_d_0747.models.Mahasiswa
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutLoading = findViewById(id.layout_loading)
        srMahasiswa = findViewById(id.sr_mahasiswa)
        svMahasiswa = findViewById(id.sv_mahasiswa)
        ...
        val fabAdd = findViewById<FloatingActionButton>(id.fab_add)
        fabAdd.setOnClickListener{
            val i = Intent(this@MainActivity, AddEditActivity::class.java)
            startActivityForResult(i, LAUNCH_ADD_ACTIVITY)
        }

        val rvProduk = findViewById<RecyclerView>(id.rv_mahasiswa)
